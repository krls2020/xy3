# Margin
> A collection of utility classes to add spacing between elements.  ·  Layout · JS
...
## JS — attr `uk-margin="…"` · api `UIkit.margin(el, opts)`

| Option | Default | Description |
|---|---|---|
| `margin ` | `uk-margin-small-top` | This class is added to items that break into the next row, typically to create a margin for the previous row. |
