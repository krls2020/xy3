# Section
> Create horizontal layout sections with different background colors and styles.  ·  Category: **Layout**

<sub>Source: [getuikit.com/docs/section](https://getuikit.com/docs/section) · demo: `tests/section.html`</sub>
...
[container](container.md) · [inverse](inverse.md) · [card](card.md) · [padding](padding.md)
