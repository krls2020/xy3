# Text
> A collection of utility classes to style text.  ·  Category: **Utilities**

<sub>Source: [getuikit.com/docs/text](https://getuikit.com/docs/text) · demo: `tests/text.html`</sub>
