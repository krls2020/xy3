# Padding
> A collection of utility classes to add spacing between elements and their content.  ·  Category: **Layout**

<sub>Source: [getuikit.com/docs/padding](https://getuikit.com/docs/padding) · demo: `tests/padding.html`</sub>
