# Background
> A collection of utility classes to add different backgrounds to elements.  ·  Category: **Utilities**

<sub>Source: [getuikit.com/docs/background](https://getuikit.com/docs/background) · demo: `tests/background.html`</sub>
...
[inverse](inverse.md) · [padding](padding.md)
