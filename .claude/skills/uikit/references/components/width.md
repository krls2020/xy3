# Width
> Define the width of elements for different viewport sizes.  ·  Category: **Layout**

<sub>Source: [getuikit.com/docs/width](https://getuikit.com/docs/width) · demo: `tests/width.html`</sub>
...
[grid](grid.md) · [visibility](visibility.md)
