# Table
> Easily create nice looking tables, which come in different styles.  ·  Category: **Content**

<sub>Source: [getuikit.com/docs/table](https://getuikit.com/docs/table) · demo: `tests/table.html`</sub>

## Usage

To apply this component, add the `.uk-table` class to a `` element.
...
[utility](utility.md) · [width](width.md) · [link](link.md) · [base](base.md) · [text](text.md)
