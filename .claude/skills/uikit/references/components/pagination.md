# Pagination
> Easily create a nice looking pagination to navigate through pages.  ·  Category: **Navigation**

<sub>Source: [getuikit.com/docs/pagination](https://getuikit.com/docs/pagination) · demo: `tests/pagination.html`</sub>
