# Animation
> A collection of smooth animations to use within your page.  ·  Category: **Utilities**

<sub>Source: [getuikit.com/docs/animation](https://getuikit.com/docs/animation) · demo: `tests/animation.html`</sub>
...
[scrollspy](scrollspy.md) · [utility](utility.md) · [svg](svg.md)
